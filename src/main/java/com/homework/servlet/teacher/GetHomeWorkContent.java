...
public class GetHomeWorkContent extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String homeWorkID = request.getParameter("homeWrokID");
		ApplicationContext ctx = new ClassPathXmlApplicationContext("com/homework/properties/spring-context.xml");
		AssignHomeworkService assignHomeworkService = (AssignHomeworkService) ctx.getBean("AssignHomeworkService");
		List<Assignment> sssignment = assignHomeworkService.getHomeWorkContent(homeWorkID);
		try {
