...
/**
 * Servlet implementation class Get_TheClass_Delete
 */
public class Get_TheClass_Delete extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public Get_TheClass_Delete() {
		super();
	...
	protected void doGet(HttpServletRequest request,
		...
		TheClassService.GetTheClassDelete(id);
		out.flush();
		out.close();
	}
