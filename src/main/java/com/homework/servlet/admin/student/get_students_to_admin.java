...
/**
 * Servlet implementation class get_students_to_admin
 */
public class get_students_to_admin extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public get_students_to_admin() {
		super();
	...
	protected void doGet(HttpServletRequest request,
		...
		String Data = StudentService.Get_Students(page_m, grade, the_class);
		out.print(Data);
		out.flush();
		out.close();
	}
