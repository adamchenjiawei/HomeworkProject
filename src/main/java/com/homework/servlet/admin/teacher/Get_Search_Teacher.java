...
/**
 * Servlet implementation class Get_Search_Teacher
 */
public class Get_Search_Teacher extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public Get_Search_Teacher() {
		super();
	...
	protected void doGet(HttpServletRequest request,
		...
		String Data = TeaCherService.search_Teachers(page_m,name_tos);
		out.print(Data);
		out.flush();
		out.close();
