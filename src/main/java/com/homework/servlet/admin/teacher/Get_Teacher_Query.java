...
/**
 * Servlet implementation class Get_Teacher_Query
 */
public class Get_Teacher_Query extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public Get_Teacher_Query() {
		super();
	...
	protected void doGet(HttpServletRequest request,
		...
		String Data = TeacherService.query_teacher(Integer.parseInt(id));
		out.print(Data);
		out.flush();
		out.close();
	}
